...
public class ChooseP1Tank implements Screen {
    ...
    public ChooseP1Tank(Application app) {
        this.app = app;
    ...
    public void show() {
        ...
        p1=new Image(new Texture(Gdx.files.internal("CP1T.png")));
        p1.setWidth(150);
        p1.setHeight(75);
        ...
        Blazer.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                app.setScreen(new ChooseP2Tank(app));
            }
        });
